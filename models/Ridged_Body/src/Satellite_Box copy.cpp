...
{
    Vector3d cent_pos;
    cent_pos << c[0], c[1], c[2];

    Matrix3d  cent_orientation;
    cent_orientation << c_ori[0][0], c_ori[0][1], c_ori[0][2],
...
{
    I_0 << 1.0 / 12.0 * m * ((l * l) + (l * l)), 0, 0,
           0, 1.0 / 12.0 * m * ((l * l) + (l * l)), 0,
           0, 0, 1.0 / 12.0 * m * ((l * l) + (l * l));

    std::cout << I_0(0, 0) << I_0(1, 0) << I_0(2, 0) << I_0(1, 0) << I_0(1, 1) << I_0(1, 2) << I_0(2, 0) << I_0(2, 1) << I_0(2, 2);
